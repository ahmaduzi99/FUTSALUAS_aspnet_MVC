...
namespace Futsal.Controllers
{
	...
	public class BookingController : Controller
	{
		...
		public IActionResult Create([FromForm] booking data, int idLapangan)
		{
			...
			/*	List<SelectListItem> start = new List<SelectListItem>();
				start.Add(new SelectListItem() { Text = "start", Value = "start" });
				start.Add(new SelectListItem() { Text = "start", Value = "08.00" });
				start.Add(new SelectListItem() { Text = "start", Value = "09.00" });
				start.Add(new SelectListItem() { Text = "start", Value = "10.00" });
				start.Add(new SelectListItem() { Text = "start", Value = "11.00" });
				start.Add(new SelectListItem() { Text = "start", Value = "12.00" });
				start.Add(new SelectListItem() { Text = "start", Value = "13.00" });
				start.Add(new SelectListItem() { Text = "start", Value = "14.00" });
				start.Add(new SelectListItem() { Text = "start", Value = "15.00" });
				start.Add(new SelectListItem() { Text = "start", Value = "16.00" });
				start.Add(new SelectListItem() { Text = "start", Value = "17.00" });
				start.Add(new SelectListItem() { Text = "start", Value = "18.00" });
				start.Add(new SelectListItem() { Text = "start", Value = "19.00" });
				start.Add(new SelectListItem() { Text = "start", Value = "20.00" });
				ViewBag.mulai = start;*/
